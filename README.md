...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-bit64-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-bit64-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `r-bit64` available on your platform:
...
```
pixi search r-bit64 --channel conda-forge
```
